...
# time points
newgrids <- seq(0,12,length.out = 299)
phihat <- eval.fd(newgrids/12,harmfd)
...
# Draw the heatmap for the slope function estimation obtained from the conventional method (Kato's method)
lt <- length(tau)
lg <- length(newgrids)
