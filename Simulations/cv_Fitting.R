...
nfolds <- 10
ncross <- ly/nfolds
fold <- c(1:ly)[-c(1:ncross+id*ncross)] # "id" here indicates the fold id.
...
cvscs <- scs[c(1:ncross+id*ncross),] # select the estimated FPC scores for the corresponding fold of data, which starts from 0
