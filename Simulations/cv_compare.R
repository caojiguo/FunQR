...
# candidate sets for tuning parameters
...
# load the information about bivariate splines
q2 <- readRDS('q2.RDS')
...
# generate the MATLAB scripts for the quadratic programming problem that needs to be submitted to MATLAB/2018b to solve 
zztmp <- paste0('sim.m')
